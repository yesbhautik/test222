    ...
    <div class="flex h-full flex-col p-7">
        <div class="mb-2 flex items-start text-[50px] font-bold leading-none text-heading-foreground">
            ...
            <div class="ms-2 mt-2 inline-flex flex-col items-start gap-2 text-[0.3em]">
                {{ $plan->type == 'prepaid' ? __('One time') : __(formatCamelCase($plan->frequency)) }}
        ...
        <p class="text-sm font-medium leading-none opacity-50 mb-5">
            {{ __($plan->name) }}
        </p>
        ...
        <ul class="my-6 text-sm text-heading-foreground">
            @if ($plan->trial_days != 0)
                <li class="mb-3">
                    <span
                        class="size-5 me-1 inline-flex items-center justify-center rounded-xl bg-primary/10 align-middle text-primary">
        ...
        <div class="mt-auto text-center">
            <a class="btn w-full rounded-md p-[1.15em_2.1em] text-[15px] group-[.theme-dark]/body:!bg-[rgba(255,255,255,1)] group-[.theme-dark]/body:!text-[rgba(0,0,0,0.9)]"
