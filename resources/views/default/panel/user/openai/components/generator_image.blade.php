...
<x-card
    ...
    x-data="{
        ...
        prompts: [
            ...
            '{{ __('Memphis style painting of a flower vase on a kitchen table with a window in the backdrop.') }}',
            ...
            '{{ __('a home built in a huge Soap bubble, windows') }}',
...
>
    ...
    >
        ...
        >
            ...
            <x-button
                class="group text-3xs font-semibold text-heading-foreground"
                tag="button"
                type="button"
                variant="link"
    ...
    >
        ...
        >
            ...
            >
                ...
                >
                    <label
                        class="min-h-64 flex w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-foreground/10 bg-background text-center transition-colors hover:bg-background/80"
                        for="img2img_src"
                    >
...
>
    ...
    <div
        class="lqd-load-more-trigger lqd-image-results-load-more-trigger min-h-px group w-full py-8 text-center font-medium text-heading-foreground"
...
@push('script')
    ...
    <script>
        ...
        (() => {
            ...
            const loadMoreTrigger = document.querySelector('.lqd-image-results-load-more-trigger');
                ...
                fetch(`{{ route('dashboard.user.openai.lazyloadimage') }}?offset=${offset}&post_type={{ $openai->slug }}`)
                    ...
                    .then(data => {
                        ...
                        images.forEach((image, index) => {
                            ...
                            imageResultTemplate.querySelector('.lqd-image-result-img').setAttribute('src', image.output);
