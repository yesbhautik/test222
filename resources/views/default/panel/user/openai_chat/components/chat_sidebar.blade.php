...
>
    ...
    <div class="chats-new mt-auto px-6 py-8 max-xl:p-4">
        ...
        @else
            @if (isset($category) && $category->slug == 'ai_pdf')
                ...
                <x-button
                    ...
                    id="btn_upload_document"
                    href="javascript:void(0);"
                    onclick="{!! $disable_actions ? 'return toastr.info(\'{{ __('This feature is disabled in Demo version.') }}\')' : 'return $(\'#selectDocInput\').click()' !!}"
                >
