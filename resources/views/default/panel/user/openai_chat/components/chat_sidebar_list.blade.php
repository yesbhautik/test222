...
<ul class="chat-list-ul h-full overflow-y-auto text-xs">
    @foreach ($list as $entry)
        ...
        >
            <div
                class="flex cursor-pointer gap-3 p-5 text-start text-heading-foreground hover:text-primary group-[&.edit-mode]:pointer-events-none dark:hover:text-heading-foreground"
