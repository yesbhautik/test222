        ...
        <x-card
            ...
            ::class="{
                'hidden': ($store.chatsFilter.searchStr !== '' || $store.chatsFilter.filter !== 'all') && (!
                    $el.getAttribute('data-title').includes($store.chatsFilter
                        .searchStr) && !$el.getAttribute('data-description').includes($store.chatsFilter.searchStr)
                ) || ($store.chatsFilter.filter !== 'all' && ($store
                    .chatsFilter.filter === 'favorite' && $el.getAttribute('data-favorite') !== 'true'))
            }"
        >
            <!-- link to the chat -->
            <a
