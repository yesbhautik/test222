<div
    class="lqd-chat-head min-h-20 sticky top-0 z-30 flex items-center justify-between gap-2 rounded-se-[inherit] border-b bg-background/80 px-5 py-3 backdrop-blur-lg backdrop-saturate-150 max-md:bg-background/95 max-md:px-4">
    ...
    <div class="flex grow items-center justify-end gap-4">
        <div class="flex gap-2">
            ...
            <div class="lqd-chat-mobile-sidebar-trigger self-center">
                <button
                    class="size-8 group grid-flow-row place-items-center rounded-full shadow-md max-md:grid md:hidden"
