...
@section('titlebar_subtitle',
    __('Just choose your topic, and watch MagicAI whip up SEO-optimized blog content in a
    matter of seconds'))
@section('titlebar_actions_before')
    <div class="mb-4 flex w-full justify-end">
        <x-remaining-credit class="text-2xs" legend-size="sm" style="inline" progress-height="sm" />
    </div>
@endsection
