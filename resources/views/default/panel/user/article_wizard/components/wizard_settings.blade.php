...
<div
    class="lqd-article-wizard group/article-wizard flex flex-wrap justify-between"
    data-step="0"
    style="--current-step: 0;"
    x-data="{ advancedSettingsShowing: false }"
>
    <div
        class="lqd-article-wizard-prompt-area flex w-full flex-col gap-6 sm:w-1/2 lg:w-5/12"
        id="settings"
    >

        <div class="lqd-steps mb-2 flex flex-col gap-3">
    ...
    <div
        class="lqd-article-wizard-meta-area group/meta-area ms-auto w-full group-[&.showing-results]/article-wizard:mx-auto group-[&.showing-results]/article-wizard:border-none group-[&.showing-results]/article-wizard:ps-0 sm:w-1/2 sm:border-s sm:ps-10 md:ps-20 lg:w-6/12">
        <div
        ...
        >
            ...
            <div
                class="select_area hidden grid-cols-2 gap-6 md:grid-cols-3 [&.active]:grid"
                id="select_image"
            ></div>
