                ...
                @foreach ($extensions as $extension)
                    ...
                    >
                        @if (trim($extension->badge, ' ') != '')
                            <p class="absolute end-2.5 top-2.5 m-0 rounded bg-[#FFF1DB] px-1.5 py-0.5 text-3xs font-semibold text-[#242425]">
                                {{ $extension->badge }}
                            </p>
                        @endif
                        <div class="size-[53px] mb-6 flex items-center rounded-xl">
                            ...
                            @if ($extension->installed)
                                <p class="ms-3 flex items-center gap-2 text-2xs font-medium">
                        ...
                        <div class="mb-7 flex flex-wrap items-center gap-2">
                            ...
                            <p class="review flex items-center gap-1 text-sm font-medium text-heading-foreground">
