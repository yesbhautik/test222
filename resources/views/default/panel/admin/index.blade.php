            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:gap-8 xl:grid-cols-4">
                ...
                >
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="grow">
                            <p class="mb-1 text-2xs font-medium text-heading-foreground/50">
                                {{ __('Total sales') }}
                            </p>
                            <h3 class="m-0 flex items-center gap-2 text-xl">
                                @if (currencyShouldDisplayOnRight(currency()->symbol))
                                    {{ number_format(cache('total_sales')) }}{{ currency()->symbol }}
                                @else
                                    {{ currency()->symbol }}{{ number_format(cache('total_sales')) }}
                                @endif
                                <x-change-indicator value="{{ $sales_change }}" />
                            </h3>
                        </div>
                    </div>
                </x-card>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="grow">
                            ...
                            <h3 class="m-0 flex items-center gap-2 text-xl">
                                ...
                                <x-change-indicator value="{{ $users_change }}" />
                            </h3>
                        </div>
                    </div>
                </x-card>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="grow">
                            ...
                            <h3 class="m-0 flex items-center gap-2 text-xl">
                                ...
                                <x-change-indicator value="{{ $generated_change }}" />
                            </h3>
                        </div>
                    </div>
                </x-card>
                ...
                <x-card>
                    ...
                    <h3 class="flex items-center gap-2">
                        ...
                        @else
                            {{ currency()->symbol }}{{ number_format(cache('total_sales')) }}
                        @endif
                        <x-change-indicator value="{{ $sales_percent }}" />
                    </h3>
