                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="phone" data-mask="+0000000000000"
                                            ...
                                            placeholder="+000000000000" autocomplete="off" value="{{ $user->phone }}" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="remaining_words" type="number"
                                            name="remaining_words" value="{{ $user->remaining_words }}" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="remaining_images" type="number"
                                            name="remaining_images" value="{{ $user->remaining_images }}" />
                                    </div>
                                </div>
                            </div>
