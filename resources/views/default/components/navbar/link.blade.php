@php
    $base_class = 'lqd-navbar-link flex items-center gap-2 ps-navbar-link-ps pe-navbar-link-pe pt-navbar-link-pt pb-navbar-link-pb rounded-xl relative transition-colors group/link
		...
		[&.active]:bg-navbar-background-hover/5 [&.active]:text-navbar-foreground-hover
		...
		group-[&.navbar-shrinked]/body:group-hover/nav-item:bg-primary/5 group-[&.navbar-shrinked]/body:group-hover/nav-item:text-primary';
