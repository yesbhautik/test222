...
<aside
    class="lqd-navbar max-lg:rounded-b-5 z-30 w-[--navbar-width] shrink-0 overflow-hidden rounded-ee-navbar-ee rounded-es-navbar-es rounded-se-navbar-se rounded-ss-navbar-ss border-e border-navbar-border bg-navbar-background text-navbar font-medium text-navbar-foreground transition-all max-lg:invisible max-lg:absolute max-lg:left-0 max-lg:top-[65px] max-lg:z-[99] max-lg:max-h-[calc(85vh-2rem)] max-lg:min-h-0 max-lg:w-full max-lg:origin-top max-lg:-translate-y-2 max-lg:scale-95 max-lg:overflow-y-auto max-lg:bg-background max-lg:p-0 max-lg:opacity-0 max-lg:shadow-xl lg:sticky lg:top-0 lg:h-screen max-lg:[&.lqd-is-active]:visible max-lg:[&.lqd-is-active]:translate-y-0 max-lg:[&.lqd-is-active]:scale-100 max-lg:[&.lqd-is-active]:opacity-100"
    x-init
...
>
    <div class="lqd-navbar-inner -me-navbar-me h-full overflow-y-auto overscroll-contain pe-navbar-pe ps-navbar-ps">
        <div
            class="relative flex min-h-[--header-height] max-w-full items-center pe-navbar-link-pe ps-navbar-link-ps group-[.navbar-shrinked]/body:w-full group-[.navbar-shrinked]/body:justify-center group-[.navbar-shrinked]/body:px-0 group-[.navbar-shrinked]/body:text-center max-lg:hidden">
            <a
                class="block px-0"
                ...
                @if (Auth::user()->type == 'admin')
                    ...
                    <x-navbar.item has-dropdown>
                        <x-navbar.link
                            ...
                            active-condition="{{ activeRouteBulk('dashboard.admin.openai.list', 'dashboard.admin.openai.custom.list', 'dashboard.admin.openai.categories.list') }}"
                            dropdown-trigger
                        />
                        <x-navbar.dropdown.dropdown
                            open="{{ activeRouteBulk('dashboard.admin.openai.list', 'dashboard.admin.openai.custom.list', 'dashboard.admin.openai.categories.list', 'dashboard.email-templates.*') }}"
                        >
                    ...
                    <x-navbar.item has-dropdown>
                        <x-navbar.link
                            ...
                            icon="tabler-device-laptop"
                            active-condition="{{ activeRouteBulk('dashboard.admin.settings.*') }}"
                            dropdown-trigger
                        />
                        <x-navbar.dropdown.dropdown open="{{ activeRouteBulk('dashboard.admin.settings.*') }}">
