@php
    ...
    $modal_base_class = 'lqd-modal-modal z-50 flex items-center justify-center overflow-y-auto overscroll-contain';
    ...
    $modal_content_base_class = 'lqd-modal-content relative z-50 max-h-[95vh] min-w-[min(calc(100%-2rem),540px)] rounded-xl bg-background shadow-2xl shadow-black/10';
    ...
    if ($type === 'page') {
        ...
        $modal_close_btn_base_class .= ' absolute top-0 end-0 bg-background text-heading-foreground size-14 rounded-full hover:bg-background hover:scale-110';
    }
@endphp
