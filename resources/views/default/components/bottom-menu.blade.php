    ...
    <ul class="relative h-full text-2xs font-medium text-heading-foreground">
        @foreach ($aiWriters as $aiWriter)
            <li class="relative">
                ...
                >
                    <span
                        class="avatar size-9 relative transition-all duration-300 [&_svg]:h-[20px] [&_svg]:w-[20px]"
