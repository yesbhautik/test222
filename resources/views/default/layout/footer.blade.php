    ...
    <div class="relative">
        <div class="container mb-28">
            <div class="mx-auto w-1/2 text-center max-lg:w-10/12 max-sm:w-full">
                <p class="mb-9 text-xs font-semibold uppercase tracking-widest">
                ...
                <p
                    class="-from-[5%] font-heading mb-8 bg-gradient-to-br from-transparent to-white to-50% bg-clip-text text-[100px] font-bold leading-none tracking-tight text-transparent max-sm:text-[18vw]">
                    {{ __($fSetting->footer_header) }}
                </p>
                <p class="font-heading mb-9 px-10 text-[20px] font-normal leading-[1.25em] opacity-50">
