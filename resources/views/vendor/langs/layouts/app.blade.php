...
@section('titlebar_actions')
    <div class="flex flex-wrap items-center gap-3">
        @if (!activeRoute('elseyyid.translations.lang'))
            <x-button href="{{ route('elseyyid.translations.lang.reinstall') }}" variant="ghost-shadow">
        ...
        @else
            ...
            <form class="relative hidden" id="new-string-form" action="{{ route('elseyyid.translations.lang.newString') }}"
                method="GET">
                <input class="bg-[#F1EDFF]" id="new-string" type="text" name="newString"
        ...
        <x-button href="{{ $app_is_demo ? 'javascript:void(0);' : route('elseyyid.translations.lang.publishAll') }}"
