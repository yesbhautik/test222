...
@section(config('elseyyid-location.content_section'))
        ...
        <div class="col-md-12">
            ...
            <form action="{{route('dashboard.admin.translations.auto', [$lang])}}" method="POST">
                @csrf
                <button type="submit" class="btn btn-secondary rounded-xl mb-2">{{__('Auto Translate (Each click will translate the next 100 key)')}}</button>
            </form>
            <div class="card">
