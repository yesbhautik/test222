                    ...
                    <div class="card-body p-16 text-center max-md:p-8">
                        ...
                        >
                            ...
                            <p class="mb-4 text-[15px] leading-[1.53em] text-heading-foreground lg:mx-auto lg:w-2/3">
                                {{ __('Thanks for purchashing') }} {{ $setting->site_name }}! {{ __('Please connect to') }} <a
                                    class="underline"
                            ...
                            <input
                                type="hidden"
                                name="return_url"
                                value="{{ url('/') }}/activate?callback=true"
                            />
                            ...
                            <button
                                class="btn btn-primary w-full rounded-full px-10 py-[0.75rem]"
                                type="submit"
                            >
