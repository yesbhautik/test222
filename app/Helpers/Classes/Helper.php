...
class Helper
{
    public static function generatePaymentToken(string $slug, $license = null): string
    {
        $license = $license ?? self::settingTwo('liquid_license_domain_key');

        $domain = request()->getHost();

        return base64_encode($domain . ':'.$slug . ':' . $license);
    }
