...
Route::get('/install-extension/{slug}/test', [InstallationController::class, 'installExtension']);
...
Route::get('/uninstall-extension/{slug}/test', [InstallationController::class, 'uninstallExtension']);
